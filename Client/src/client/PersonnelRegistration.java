 ...
 * @author Irana
 */
public class PersonnelRegistration extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeRegistration
     */
    public PersonnelRegistration() {
        initComponents();
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation((int) (d.getWidth() - this.getWidth()) / 2, (int) (d.getHeight() - this.getHeight()) / 2);
        this.setTitle("Personnel Registration");
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" Student and Personnel Automation of Isfahan University");
        ...
        combo_level.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Diploma", "Associate", "BSC", "MSC", "PHD" }));
        ...
        txt_post.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        lab_post.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        lab_post.setForeground(new java.awt.Color(255, 0, 0));
        lab_post.setText("*");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_lastname, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(39, 39, 39)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_field, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(txt_password2, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_registerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_registerMouseClicked
        // TODO add your handling code here:
        boolean f = true;
        if (!txt_name.getText().isEmpty() && !txt_lastname.getText().isEmpty() && !txt_ncode.getText().isEmpty() && !txt_id.getText().isEmpty() && !txt_post.getText().isEmpty()) {
            try {
                    ...
                    if (Client.is.readBoolean()) {
                        ...
                        if (txt_password.getText().length() >= 8) {
                            ...
                            if (txt_password.getText().equals(txt_password2.getText())) {
                                ...
                                Client.os.flush();
                                lab_passwarning.setText("at least 8 caharacters");
                                Employee e = new Employee(txt_name.getText(), txt_lastname.getText(), txt_ncode.getText(), txt_id.getText(), (String) combo_level.getSelectedItem(), txt_field.getText(), txt_post.getText(), txt_password.getText());
                                Client.os.writeObject(e);
                                Client.os.flush();
